...
[Испытательный стенд AS5600](https://www.thingiverse.com/thing:6514317)
...
# Рекомендация по использованию магнита
Используйте только тот магнит, который шел в комплекте с платой датчика AS5600. Показания угла при использовании других магнитов, 
скорее всего, не будут покрывать дианазон 0..359.0 градусов!